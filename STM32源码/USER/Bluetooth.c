...
void InitEsp8266()
{
		char cmd_mode_1[]="AT+CWMODE=1\r\n";
		char cmd_wifi_connect[]="AT+CWJAP=\"DESKTOP-9IO7DFP 2175\",\"ttttwwww\"\r\n";
		char cmd_tcp_connect[]="AT+CIPSTART=\"TCP\",\"192.168.137.1\",8080\r\n";
		char cmd_transport[]="AT+CIPMODE=1\r\n";
		char cmd_transport_send[]="AT+CIPSEND\r\n";
		USART3SendDataPacket(cmd_mode_1,strlen(cmd_mode_1));
		delayms(1000);
		USART3SendDataPacket(cmd_wifi_connect,strlen(cmd_wifi_connect));
		delayms(5000);
		USART3SendDataPacket(cmd_tcp_connect,strlen(cmd_tcp_connect));
		delayms(1000);
		USART3SendDataPacket(cmd_transport,strlen(cmd_transport));
		delayms(1000);
		USART3SendDataPacket(cmd_transport_send,strlen(cmd_transport_send));
